...
- Optional: allow registering from existing account an another API server (i.e. Mojang's) (see [RegistrationUsernamePassword.ExistingPlayer](doc/configuration.md))
